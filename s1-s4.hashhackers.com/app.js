...
function nav(path) {
  ...
  <a class="navbar-brand" href="https://index.hashhackers.com">${UI.logo_image ? '<img border="0" alt="'+UI.company_name+'" src="'+UI.logo_link_name+'" height="'+UI.height+'" width="'+UI.logo_width+'">' : UI.logo_link_name}</a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
      <li class="nav-item">
        <a class="nav-link" href="https://index.hashhackers.com">${UI.nav_link_1}</a>
      </li>`;
    var names = window.drive_names;
    var drive_name = window.drive_names[cur];

    html += `<li class="nav-item dropdown"><a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">${UI.nav_link_3}</a><div class="dropdown-menu" aria-labelledby="navbarDropdown">`;
...
<form class="d-flex" method="get" action="https://index.hashhackers.com/0:search">
...
function list(path) {
  ...
  <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
    <ol class="breadcrumb" id="folderne"><li class="breadcrumb-item"><a href="https://index.hashhackers.com">Home</a></li>`;
  var navlink = '';
