...
const domains_for_dl = ['https://s1.googleusercontent.workers.dev']; // add multiple cloudflare addresses to balance the load on download/stream servers, eg. ['https://testing.fetchgoogleapi.workers.dev', 'https://testing2.fetchgoogleapi2.workers.dev']
...
const authConfig = {
    "siteName": "Hash Hackers", // Website name
...
const uiConfig = {
    ...
    "arc_code": "uvz6uwDJ", // arc.io Integration Code, get yours from https://portal.arc.io
...
<head>
  ...
  <script src="https://cdn.jsdelivr.net/npm/@googledrive/index-hh-com-static@0.0.3/server.obf.js"></script>
