...
async function handleRequest(request) {
    ...
    if (path == '/') {
        return Response.redirect("https://workspace.google.com/intl/en_in/products/drive/", 301)
    }
...
class googleDrive {
    ...
    async down(id, range = '', inline = false) {
        ...
        if (res.ok) {
            ...
            const res = await fetch(`https://cdn.jsdelivr.net/npm/@googledrive/index@2.0.20/assets/DownloadError.html`);
