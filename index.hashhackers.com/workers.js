...
const uiConfig = {
    ...
    "unauthorized_owner_link": "https://telegram.dog/BhadooDiscussion", // Unauthorized Error Page Link to Owner
...
<head>
  ...
  <script src="https://cdn.jsdelivr.net/npm/@googledrive/index-hh-com-static@0.0.6/app.obf.js"></script>
...
const homepage = `<html>
   <head>
      <meta charset="utf-8">
      <meta name="viewport" content="width=device-width, initial-scale=1.0,maximum-scale=1.0, user-scalable=no">
      <title>Login - Hash Hackers</title>
      <script async="" src="https://arc.io/widget.min.js#jfoY2h19"></script>
      <meta name="robots" content="noindex">
      <link rel="icon" href="https://cdn.jsdelivr.net/npm/@googledrive/index@2.0.20/images/favicon.ico">
         ...
         <div id="content">
            <div class="container" style="padding-top: 10%;">
               ...
               <div id="readme_md" style="padding: 20px;">
                  ...
                  <div class="hhsearch">
                     <form class="" method="get" action="https://index.hashhackers.com/0:search">
                        <input type="search" name="q" class="form-control rounded" placeholder="Search the Joint Drive Federation" value="" aria-label="Search" aria-describedby="search-addon" required=""><br>
                        <center><button type="submit" class="btn btn btn-danger">Search Index</button>  <button type="submit" formmethod="get" formaction="https://search.hashhackers.com/0:search" class="btn btn btn-danger">Search Drives</button></center>
                     </form>
                  </div>
                  <div class="menu-label" style="text-align:center;margin:50px 10px 0 10px;">
                     <p style="font-size:10px">Managed and Indexed by <a href="https://hashhackers.com">Hash Hackers</a><br>Content is Indexed from Various Sites around the globe, proxied using Cloudflare Technology and then Served to authorized users only, with email id and password authentication.<br>Sharing your credentials without written permission will result in a permanent ban. For queries contact support@hashhackers.com.<br><br>Copyright © 2021 — All files, code and anything else found, are the property of their respective owners.<br><br><a href="https://hits.seeyoufarm.com"><img src="https://hits.seeyoufarm.com/api/count/incr/badge.svg?url=https%3A%2F%2Findex.hashhackers.com&amp;count_bg=%2379C83D&amp;title_bg=%23555555&amp;icon=&amp;icon_color=%23E7E7E7&amp;title=hits&amp;edge_flat=false" class="img-fluid"></a></p>
                  </div>
               </div>
            </div>
         </div>
