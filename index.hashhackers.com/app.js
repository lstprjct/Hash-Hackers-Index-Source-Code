...
function list(path) {
  ...
  <div class="container" style="padding-top: 10%;">
       ...
       <center><img src="https://images.cdn.hashhackers.com/logo/logo-white-d.svg" alt="Hash Hackers" border="0" height="80px" width="100%" style="margin-top: 10px;"><br><br><br></center>
       <div class="hhsearch">
        <form class="input-group" method="get" action="/0:search">
        <input type="search" name="q" class="form-control rounded" placeholder="Search" value="${search_text}" aria-label="Search"
          aria-describedby="search-addon" required>
         <button type="submit" class="btn ${UI.search_button_class}">Search</button>
        </form>
       </div>
       <style>a,a:hover,a:focus{color:#fff}</style><div class="menu-label" style="text-align:center;margin:50px 10px 0 10px;"><p style="font-size:10px">Managed and Indexed by <a href="https://hashhackers.com">Hash Hackers</a><br>Content is Indexed from Various Sites around the globe, proxied using Cloudflare Technology and then Served to authorized users only, with email id and password authentication.<br>Sharing your credentials without written permission will result in a permanent ban.<br><br>Copyright © 2021 — All files, code and anything else found are the property of their respective owners.<br><br><a href="https://hits.seeyoufarm.com"><img src="https://hits.seeyoufarm.com/api/count/incr/badge.svg?url=https%3A%2F%2Findex.hashhackers.com&amp;count_bg=%2379C83D&amp;title_bg=%23555555&amp;icon=&amp;icon_color=%23E7E7E7&amp;title=hits&amp;edge_flat=false" class="img-fluid"></a></p></div></div>
    </div>
    `;
...
function render_search_result_list() {
  ...
  <div id="readme_md" style="padding: 20px;">
                    <div class="hhsearch">
                       <form method="get" action="https://index.hashhackers.com/0:search">
                          <input type="search" name="q" class="form-control rounded" placeholder="Search the Joint Drive Federation" value="${search_text}" aria-label="Search" aria-describedby="search-addon" required=""><br>
                          <center><button type="submit" class="${UI.search_button_class}">Search Index</button>  <button type="submit" formmethod="get" formaction="https://search.hashhackers.com/0:search" class="${UI.search_button_class}">Search Drives</button></center>
                       </form>
                    </div>
                 </div>
  <div class="card">
  <div class="${UI.path_nav_alert_class} d-flex align-items-center" role="alert" style="margin-bottom: 0;">Search Results for ${search_text}</div>
 ...
 */
 function onSearchResultItemClick(a_ele) {
     ...
     if (teamDriveId == "xxxxxxxxxxxxxxxxxxxxxxxxx"){
       var searchhost = "https://s1.hashhackers.com/0";
     }
     else if (teamDriveId == "xxxxxxxxxxxxxxxxxxxxxxxxx"){
       var searchhost = "https://s1.hashhackers.com/1";
     }
     else if (teamDriveId == "xxxxxxxxxxxxxxxxxxxxxxxxx"){
       var searchhost = "https://s1.hashhackers.com/2";
     }
     else if (teamDriveId == "xxxxxxxxxxxxxxxxxxxxxxxxx"){
       var searchhost = "https://s1.hashhackers.com/3";
     }
     else if (teamDriveId == "xxxxxxxxxxxxxxxxxxxxxxxxx"){
       var searchhost = "https://s1.hashhackers.com/4";
     }
     else if (teamDriveId == "xxxxxxxxxxxxxxxxxxxxxxxxx"){
       var searchhost = "https://s2.hashhackers.com/0";
     }
     else if (teamDriveId == "xxxxxxxxxxxxxxxxxxxxxxxxx"){
       var searchhost = "https://s2.hashhackers.com/1";
     }
     else if (teamDriveId == "xxxxxxxxxxxxxxxxxxxxxxxxx"){
       var searchhost = "https://s2.hashhackers.com/2";
     }
     else if (teamDriveId == "xxxxxxxxxxxxxxxxxxxxxxxxx"){
       var searchhost = "https://s2.hashhackers.com/3";
     }
     else if (teamDriveId == "xxxxxxxxxxxxxxxxxxxxxxxxx"){
       var searchhost = "https://s2.hashhackers.com/4";
     }
     else if (teamDriveId == "xxxxxxxxxxxxxxxxxxxxxxxxx"){
       var searchhost = "https://s3.hashhackers.com/0";
     }
     else if (teamDriveId == "xxxxxxxxxxxxxxxxxxxxxxxxx"){
       var searchhost = "https://s3.hashhackers.com/1";
     }
     else if (teamDriveId == "xxxxxxxxxxxxxxxxxxxxxxxxx"){
       var searchhost = "https://s3.hashhackers.com/2";
     }
     else if (teamDriveId == "xxxxxxxxxxxxxxxxxxxxxxxxx"){
       var searchhost = "https://s3.hashhackers.com/3";
     }
     else if (teamDriveId == "xxxxxxxxxxxxxxxxxxxxxxxxx"){
       var searchhost = "https://s3.hashhackers.com/4";
     }
     else if (teamDriveId == "xxxxxxxxxxxxxxxxxxxxxxxxx"){
       var searchhost = "https://s4.hashhackers.com/0";
     }
     else if (teamDriveId == "xxxxxxxxxxxxxxxxxxxxxxxxx"){
       var searchhost = "https://s4.hashhackers.com/1";
     }
     else if (teamDriveId == "xxxxxxxxxxxxxxxxxxxxxxxxx"){
       var searchhost = "https://s4.hashhackers.com/2";
     }
     else if (teamDriveId == "xxxxxxxxxxxxxxxxxxxxxxxxx"){
       var searchhost = "https://s4.hashhackers.com/3";
     }
     else if (teamDriveId == "xxxxxxxxxxxxxxxxxxxxxxxxx"){
       var searchhost = "https://s4.hashhackers.com/4";
     }
     else {
       var searchhost = "/0";
     }
