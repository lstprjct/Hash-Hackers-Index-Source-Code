...
function nav(path) {
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <a class="nav-link" href="${UI.nav_link_3}" target="_blank">Get Access</a>
  </li>
  <li class="nav-item">
...
function render_search_result_list() {
  ...
  <div id="readme_md" style="padding: 20px;">
                    ...
                    <div class="menu-label" style="text-align:center;margin:50px 10px 0 10px;">
                       <p style="font-size:15px">WARNING: DO NOT CLICK ON REQUEST ACCESS AT GOOGLE DRIVE PAGE, THIS WILL RESULT IN PERMANENT BAN ON YOUR GMAIL ACCOUNT. INSTEAD GO TO MENU AND JOIN GOOGLE GROUP.</p>
                    </div>
                 </div>
  <div class="card">
