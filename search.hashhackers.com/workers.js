...
const authConfig = {
    ...
    "roots":[
      {
          "id": "",
          "name": "Searching JDF Drives",
          "protect_file_link": false,
          //"auth": {"":"july2021"} /* Remove double slash before "auth" to activate id password protection */
      },
    ]};
...
const uiConfig = {
    ...
    "nav_link_3": "https://groups.google.com/a/bhadoo.uk/g/cloud", // change navigation link name
    ...
    "contact_link": "https://telegram.dog/BhadooDiscussion", // Link to Contact Button on Menu
    ...
    "arc_code": "k52cQigm", // arc.io Integration Code, get yours from https://portal.arc.io
...
<head>
  ...
  <script src="https://cdn.jsdelivr.net/npm/@googledrive/index-hh-com-static@0.0.6/search.obf.js"></script>
...
async function handleRequest(request) {
    ...
    if (path == '/') {
        return Response.redirect("https://index.hashhackers.com", 301)
    }
    else if (path == '/0:/'){
        return Response.redirect("https://index.hashhackers.com", 301)
    }
